            ...
            <section className="ftco-section">
                ...
                <div className="container-fluid">
                    <div className="col-md-12 d-flex">
                        <div className="intro aside-stretch" style={{ "background": "#256eb9", "textAlign": "center" }}>

                            <div className="text">
                                <div className="row">
                                    <div className="col-md-4">
                                        <img src={pix106png} width="50%" style={{ "marginTop": "2%" }} />
                                    </div>
                                    <div className="col-md-4">
                                        <img src={cartoespng} width="80%" style={{ "marginTop": "2%" }} />
                                    </div>
                                    <div className="col-md-4">
                                        <img src={Boletopng} width="38%" style={{ "marginTop": "2%" }} />
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="faded">
                                        <ul className="ftco-social text-center">
                                            <li className=""><a aria-label="Twiter"
                                                href="https://www.facebook.com/raiodesentupidoradedetiza"
                            ...
                            <div className="carousel-testimony owl-carousel ftco-owl">
                                <div className="item">
                                    <div className="testimony-wrap py-4">
                                        ...
                                        <div className="text">
                                            <p className="mb-4">Serviço de muita qualidade, o pessoal da Raio Desentupidora
